...
export default new Vuex.Store({
  ...
  productMenu1({commit,state},payload) {
    return new Promise((resolve, reject) => {
      axios.defaults.headers.common['Authorization'] = `Bearer ${state.Userinfo.User_token}`
      axios.post('http://3.36.159.227:9000/api/auth/productMenu1', payload)
        .then(Response => {
          console.log(payload)
  ...
  productCategory({commit,state}) {
    return new Promise((resolve, reject) => {
      axios.defaults.headers.common['Authorization'] = `Bearer ${state.Userinfo.User_token}`
      axios.get('http://3.36.159.227:9000/api/auth/productCategory')
        .then(Response => {
          //console.log(Response.data)
  ...
  submitFile({commit}, payload) {
    ...
    formDate,append('file', payload)
    axios.post('http://3.36.159.227:9000/api/auth/upload',formData, {
      headers: {
